...
import com.decathlon.matrix_skills.partner.Partner;
...
public class Skill {
  ...
  @OneToOne
    ...
    public com.decathlon.matrix_skills.Skill.SkillsLevel getSkillsLevel() {
        return SkillsLevel;
    }

    public void setSkillsLevel(com.decathlon.matrix_skills.Skill.SkillsLevel skillsLevel) {
